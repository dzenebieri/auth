...
export default function SignUpBN({ onClick, disabled, children, type }) {
  const styles = {
    ...
    secondary:
      'h-[52px] w-[300px] sm:w-[364px] rounded-md border border-neutral-800 px-4 bg-[#00a400] text-white text-lg font-semibold hover:bg-gradient-to-t from-[#79bc64] to-[#578843]',
  };
