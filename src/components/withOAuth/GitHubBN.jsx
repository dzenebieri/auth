  ...
  return (
    <div className="flex items-center justify-center">
      <GitHubLogin
        ...
        className="flex h-[52px] w-[300px] items-center justify-center rounded-md border-[calc(.06887vw+.67769px)] border-solid border-[rgb(35,134,54)] bg-[rgb(35,134,54)] text-sm font-semibold opacity-100 hover:rounded-md hover:bg-[rgb(46,160,67)] sm:w-[364px]"
      >
        <div className="flex items-center justify-center">
